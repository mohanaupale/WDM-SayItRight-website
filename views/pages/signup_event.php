  ...
  <body>
    ...
    <section>
      ...
      <div class="sign_up-div">
        ...
        <div id="Event-form">
         <hr>
         <label for="welcome">Welcome to Event log</label>
         <?php echo validation_errors(); ?>
         <form id="Sign-E-form" method="POST" action="<?php echo base_url();?>Signup_Event/create_user">
           <input name="Fname" type="text" placeholder="Enter your name" pattern="[A-Za-z]{2,16}" title="2 characters minimum" value="<?php echo set_value('Fname'); ?>" required>
